...
{
	public enum Type { Conference, Journal, Other };    // enum of the things a publication can be
    ...
    public class Publication
    {
		...
		public Type Type { get; set; }  // enum type of publication
        ...
        public override string ToString()
        {
            ...
            return Title + " completed by " + Type + " on " + Certified.ToShortDateString();
